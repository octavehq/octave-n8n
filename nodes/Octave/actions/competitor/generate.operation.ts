...
const properties: INodeProperties[] = [
    {
        ...
        default: '',
        description: 'Primary offering to associate with generated competitors (optional). Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
    ...
    },
    {
        ...
        default: 'ALL',
        description: 'Strategy for linking generated competitors to products',
    },
    {
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[][] | null> {
    ...
    // Process competitors and fix sources structure from fixedCollection
    const competitorsRaw = this.getNodeParameter('competitors', itemIndex) as Array<{
        name?: string;
        sources: { source?: Array<{ type: 'TEXT' | 'URL'; value: string }> };
    }>;

    body.competitors = competitorsRaw.map(competitor => ({
        name: competitor.name,
        sources: competitor.sources?.source || []
    }));
    ...
    const responseData = await octaveApiRequest.call(this, 'POST', '/api/v2/competitor/generate', body);
