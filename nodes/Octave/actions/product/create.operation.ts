...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[][] | null> {
    ...
    if (!body.name) {
        throw new NodeOperationError(this.getNode(), 'Name is required to create a product.', { itemIndex });
    }
    ...
    const responseData = await octaveApiRequest.call(this, 'POST', '/api/v2/product/create', body);
