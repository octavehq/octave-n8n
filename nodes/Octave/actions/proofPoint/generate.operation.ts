...
const properties: INodeProperties[] = [
    {
        ...
        required: true,
        default: '',
        description: 'Primary offering OId to associate with generated proof points',
    },
    {
        ...
        required: true,
        default: '[]',
        description: 'JSON configuration for generating proof points',
        typeOptions: { rows: 10 }
    },
    {
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[][] | null> {
    ...
    if (!body.primaryOfferingOId) {
        throw new NodeOperationError(this.getNode(), 'Primary Offering OId is required to generate proof points.', { itemIndex });
    }
    ...
    const responseData = await octaveApiRequest.call(this, 'POST', '/api/v2/proof-points/generate', body);
