...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[][] | null> {
	...
	const body: Record<string, any> = { name, sources };
	...
	body.enableRagEnrichment = this.getNodeParameter('enableRagEnrichment', itemIndex) as boolean;
	...
	const responseData = await octaveApiRequest.call(this, 'POST', '/api/v2/solution/generate', body);
