...
const properties: INodeProperties[] = [
    {
        ...
        required: true,
        default: '',
        description: 'Primary offering OId to associate with generated use cases',
    },
    {
        ...
        required: true,
        default: '[]',
        description: 'JSON configuration for generating use cases',
        typeOptions: { rows: 10 }
    },
    {
...
export async function execute(this: IExecuteFunctions, itemIndex: number): Promise<INodeExecutionData[][] | null> {
    ...
    if (!body.primaryOfferingOId) {
        throw new NodeOperationError(this.getNode(), 'Primary Offering OId is required to generate use cases.', { itemIndex });
    }
    ...
    const responseData = await octaveApiRequest.call(this, 'POST', '/api/v2/use-cases/generate', body);
